...
<div class="wrapper" id="main">
  ...
  <nav class="navbar navbar-expand" style="width: 100%;">
    ...
    <ul class="nav-menu list-unstyled ml-auto d-flex flex-md-row align-items-md-center">
      <li class="nav-item d-none d-sm-inline-block">
        <a href="help/support.php" class="nav-link text-decoration-underline font-weight-bold"><i class="fas fa-question-circle"></i> Support</a>
      </li>  
      <!-- Languages dropdown    -->
          ...
          <ul aria-labelledby="languages" class="dropdown-menu"> </li>
            <?php if(isset($_SESSION['currentpage']) && $_SESSION['currentpage'] == "account/dashboard.php?client=69456") {?>
              <li>
                    ...
                    <li><a href='support.php' class='text-decoration-none rounded text-dark p-2 m-2'> <i class='fas fa-question icc'></i> <span class='d-none d-sm-inline-block'>Support </span> </a></li>
            <?php }else {
              echo "<li>
                        <a class='text-decoration-none rounded text-white'> 
                          <form action='' method='post'>
    ...
    <div class="wrapper-c">
      ...
      <div class="sfund">
        <div class="row text-center rowcc">
          ...
          <div class="col-md-3 fru">
            <form action="mywithdrawals/setwithdrawal.php" method="post">
      ...
      <div class="col-inn" id="lln">
        ...
        <i class="fas fa-check-circle mr-3" ></i> Withdrawal details
          ...
          Total raised (after <a href="http://" class="text-primary">fees</a> )
