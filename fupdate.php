                ...
                echo "<div class='mfrs'>";
                    ...
                    echo "<div class=' bg-white'>
                            ...
                            <div class='mfrsc'>
                                ...
                                <div class='mf'><a rel='nofollow' style='cursor:pointer' data-toggle='modal' data-target='#upF' name='$fundraiserId' aria-haspopup='true' aria-expanded='false' id='fup' onclick='getId()' class='nav-btn text-dark'> Share fundraiser progress update</a></div>
                            </div>
