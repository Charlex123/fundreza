...
<div class="wrapper" id="main">
  ...
  <div class="content-wrapperr">
    ...
    <div class="wrapper-c">
      ...
      <?php if(isset($_POST['verifyBank'])) {?>
              <div class="w-f">

                <div class="cet"><h4>Set Up Withdrawal Type</h4></div>
                  
                  <form action="" method="POST" class="form-validate text-center">
                      
                      <div class="form-group">
                          <label for="" class="text-left"> Who will withdraw the funds?</label>
                          <select name='fundbeneficiary' id='-cur' class="form-control">
                              <option value=''> -Select Beneficiary- </option>
                              <option value='myself'> Myself </option>
                              <option value='someone else'> Someone else </option>
                          </select>
                          <div class="ser"><small>Must be 18+ with valid ID Card</small></div>
                      </div>


                      <div class="form-group">
                          <label for="" class="text-left"> What type of entity withdrawal is right for you?</label>
                          <select name='fundbeneficiary' id='-cur' class="form-control">
                              <option value=''> -Select Withdrawal Entity- </option>
                      ...
                      <div class="form-group">
                        ...
                        <a href="http://"> check details here</a>
                        
                        <div class="col-12 setr">
                          <ul>
                            <li>
                                <i class="fas fa-hand-point-right"></i> Account can belong to a person or an organization
                            </li>
                            <li>
                                <i class="fas fa-hand-point-right"></i> For organizational withdrawal, the individual withdrawing must be a beneficial owner, i.e someone with significant responsibility to control, manage or direct
                                the organizational affairs (e.g CEO, Vice President, Treasurer or Cordinator and others high ranking offices) 
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="form-group mt-2 mx-auto text-center">
                        <button id="" type="submit" name="successConfirm" class="nf" id='submit_account'>Confirm</button>
                        <div><small><em>PS: ensure all details provided are valid and correct</em></small></div>
                      </div>
                      ...
                      <div class="sml">
                        ...
                        <div class="gbk">
                          <a href="connect-bank.php"> Go back</a>
                        </div>
                        <div class="gbk">
            ...
            <?php if(isset($_POST['successConfirm'])) {?>
              <div class="w-f">

                <div class="cet"><h4>Set Up Complete</h4></div>
                  
                  <form action="" method="POST" class="form-validate text-center">
                      
                      <div class="mx-auto text-center">
                        <i class="far fa-check-circle"></i>
                        <div class="mt-3">Congratulations, your withdrawal set up is complete. You will start receiving your funds when you request</div>
                      </div>
                      
                      <div class="form-group mt-2 mx-auto text-center">
                        <button id="" type="submit" name="successConfirm" class="nf" id='submit_account'>Got it</button>
                      </div>
                  </form>
              </div>
            <?php }?>
