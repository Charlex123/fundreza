...
<div class="wrapper" id="main">
  ...
  <div class="content-wrapperr">
    ...
    <div class="wrapper-c">
      ...
      <?php if(isset($_POST['setWidth'])) {?>
              <div class="w-f">

                <div class="cet"><h4>Set Up Withdrawal Type</h4></div>
                  
                  <form action="connect-bank.php" method="POST" class="form-validate text-center">
                      ...
                      <div class="form-group mt-2 mx-auto text-center">
                        <button id="" type="submit" name="setWithd2" class="nf" id='submit_account'>Next</button>
                      </div>
                      ...
                      <div class="sml">
                        ...
                        <div class="gbk">
                          <a href="setwithdrawal.php"> Go back</a>
                        </div>
                        <div class="gbk">
