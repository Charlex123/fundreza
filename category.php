...
<div class="wrapper" id="main">
  ...
  <?php 
        ...
        <div class="tph text-dark" id="">
            <div class="m-slidef">
                ...
                <div class="ina">
                    <span class="pipa"><?php echo $r['header1'];?></span>
                    <p class="ria">
                        <?php echo $r['subCategory'];?>
                    </p>
                    <p class="pria">
                        <?php echo $bdy;?>
                    </p>
  ...
  <?php 
      ...
      AND fundraiser_table.fundraiserStatus = ? AND fundraiser_table.fundraiserCategory = ? GROUP BY fundraiser_table.fundraiserId ORDER BY fundraiser_table.dateSubmitted AND donation_table.donation_time DESC LIMIT 3");
    ...
    ?>
    <div class="container-">
      <div class="trn"><?php echo 'Trending '. $cat.' Fundraisers For You';?></div>
  ...
  foreach($rows as $row) {
    $fundraiseredB = ucwords($row['fundraiserBy']);
      ...
      <div class="a-l mt-3 mb-3 pb-5">
        <a href="<?php echo "https://fundreza.com/category-list/$ccat"?>">See All... <i class="fas fa-angle-right"></i></a>
      </div>
    </div>
    <?php } else {?>
        <div class="nof text-dark mt-5 pt-5">
            <h3 class='p-3 pt-5' style="font-family: 'PT Sans';color: #545454"> <span style="padding: .6rem;box-shadow: 2px 2px 2px 3px #f1f1f1">No <span style="color: #22a349"><?php echo @$cc = ucwords($catan);?></span> fundraiser's found?</span></h3>

            <div class="st-f mt-2">
                <div class="stn">
                <div class="rdy">Ready to raise <span style='color:#22a349;font-weight:bold;font-family: "PT Sans";'><?php echo @$catan;?></span> funds?</div>
