...
<div class="wrapper" id="main">
  ...
  <nav class="navbar navbar-expand" style="width: 100%;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../choose-type.php" class="nav-link nf"><i class="fas fa-dollar-sign"></i> Start A New Fundraiser</a>
      </li>
    ...
    <ul class="nav-menu list-unstyled ml-auto d-flex flex-md-row align-items-md-center">
      <li class="nav-item d-none d-sm-inline-block">
        <a href="profile?client=$med" class="nav-link nav-btn"> <i class="fas fa-donate"></i> Your Fundraisers </a>
      </li>  
      <!-- Languages dropdown    -->
  ...
  <div class="content-wrapperr">
    ...
    <div class="witradingview-dget-container pt-0" style="position:relative;">
      <marquee>
          <ul>
              </ul>
      </marquee>
    ...
    <div class="wrapper-c">
      ...
      <div class="row diva">
        ...
        <div class="mfr">
              ...
              <?php } if($chk -> execute() ){?>
                ...
                <div class="w-intro-head">
                  ...
                  <div class="set-w wt"><form action="" method="post">
                    <form method="POST">
        ...
        <div class="col-md-3 mx-auto text-center">
            ...
            <?php 
                ...
                $kyc -> execute();
                echo "<div class='eed'>";
                echo "<h4 class='text-dark mt-4 mb-2'> KYC Status </h4>";
              ...
              if($kyc -> execute() && $kyc -> rowCount() > 0) {
                ...
                if($dv == 'in progress') {
                  ?>
                  <div class="mfrw">
                    <div class="w-fw mx-auto text-center">
                  ...
                  <?php }else if($dv == 'verified'){?>    
                    ...
                    <div class="mfrw">
                      <div class="w-fw mx-auto text-center">
                        <div><i class="fas fa-good-circle"></i> Documents successfully verified</div>      
                      </div>
                  </div>
            ...
            <?php }}else { ?>
              ...
              <div class="mfrw">
                <div class="w-fw mx-auto text-center">
                    <i class="fas fa-times-circle" ></i> You have not uploaded your documents for verification...     
                    <div class="nh text-center mt-3"><a type="submit" href="kyc-documents.php" class="nf p-2 m-2 mt-5 text-white"> Upload now</a></div> 
                </div>
            </div>
          ...
          <div class="mfrw">
              <div class="w-fw">
                <div class="ind text-center">
                  <h6 class='text-center font-weight-bond text-dark'>Need help? Contact your Fundraiser manager</h6>
                  <div class="nhf">
                    <i class="fas fa-envelope"></i> help@helpfundme.org
                  </div>
                  <div class="nhf">
                    <i class="fas fa-phone"></i> +234 8088680922
                  </div>
                </div>
              </div>
          </div>
        ...
        <div class="modal" id="upF">
              <div class="modal-content">
                ...
                <form action="" method="POST" id="prvsub">
                  ...
                  <input name="submit" class="mx-auto text-center nf w100 sbn" id="preSub" value="Share" onclick="prevSubmit()">
                </form>
              </div>
        </div>
      </div>
      ...
      <div class="row w-body">
        <div class="col-md-6">
            <video src="../let.mp4"></video>
        </div>
        <div class="col-md-6">
          Only donations on our platform are protected by Helpfundme Guarrantee
        </div>
        <div class="col-md-6">
            <video src="../let.mp4"></video>
        </div>
