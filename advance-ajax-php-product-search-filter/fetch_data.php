...
if(isset($_POST["action"]))
{
	...
	if(isset($_POST["fundraiserType"]))
	{
		...
		$query .= "AND fundraiserType IN('".$type_filter."')";
	}
	if(isset($_POST["fundraiserCategory"]))
	{
		$categ_filter = implode("','", $_POST["ram"]);
		$query .= "AND fundraiserCategory IN('".$categ_filter."')";
	}
	...
	if($total_row > 0)
	{
		echo "<div class='row'>"; 
                ...
                echo "<div class='col-xs-12 col-sm-6 col-md-4 col-lg-3 pt-2 pb-2 ' style=''>";
                ...
                echo "<div class='mfrs'>";
                    ...
                    echo "<div class=' bg-white'>
                            ...
                            <div class='mfrsc mx-auto text-center'>
